                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <div class="me-3" style="width: 50%">
                            <label for="exampleFormControlInput1" class="form-label fw-semibold">Tanggal Dibuka</label>
                            <input type="date" class="form-control" name="tanggal_mulai"
                                id="exampleFormControlInput1">
                        </div>
                        <div style="width: 50%">
                            <label for="exampleFormControlInput1" class="form-label fw-semibold">Tanggal Ditutup</label>
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <div class="me-3" style="width: 50%">
                            <label for="exampleFormControlInput1" class="form-label fw-semibold">Waktu Dibuka</label>
                            <input type="time" class="form-control" name="waktu_mulai" id="exampleFormControlInput1">
                        </div>
                        <div style="width: 50%">
                            <label for="exampleFormControlInput1" class="form-label fw-semibold">Waktu Ditutup</label>
