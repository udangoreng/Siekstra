...
@section('main')
    <div class="kesiswaan-section">
        <div class="d-flex justify-content-between mt-2 me-5 align-items-center">
            <h2 class="fw-bolder">Akun Kesiswaan</h2>
            @include('Kesiswaan.addkesiswaan')
        </div>
        <div class="d-flex justify-content-end mt-3">
            <form class="d-flex w-25 me-5" role="search" action="/kesiswaan/kesiswaan">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Akun
                                                    </h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <form action="/kesiswaan/kesiswaan/{{ $item->id }}" method="POST">
                                                    <div class="modal-body">
                                                        @csrf
                                                        <input type="text" value="{{ $item->id }}" readonly hidden />
                                                        <div class="mb-3">
                                                            <label for="exampleFormControlInput1"
                                                                class="form-label">NIP</label>
                                                            <input type="text" class="form-control" name="NIP"
                                                                value={{ $item->username }} id="exampleFormControlInput1">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleFormControlInput1"
                                                                class="form-label">Nama</label>
                                                            <input type="text" class="form-control" name="nama"
                                                                value={{ $item->name }} id="exampleFormControlInput1">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleFormControlInput1"
                                                                class="form-label">Email</label>
                                                            <input type="text" class="form-control" name="email"
                                                                value={{ $item->email }} id="exampleFormControlInput1">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a type="submit" class="btn btn-danger"
                                                            href="/kesiswaan/kesiswaan/delete/{{ $item->id }}">Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
