...
@section('main')
    <div class="kesiswaan-section">
        <div class="d-flex justify-content-between mt-2 me-5 align-items-center">
            <h2 class="fw-bolder">Akun Siswa</h2>
            @include('kesiswaan.addsiswa')
        </div>
        <div class="d-flex justify-content-end mt-3">
            <form class="d-flex w-25 me-5" role="search" action="/kesiswaan/siswa">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Ekstra Diikuti</th>
                        <th scope="col"></th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="/kesiswaan/siswa/{{ $item->id }}">
                                        <div class="mx-3">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a type="submit" class="btn btn-danger"
                                                            href="/kesiswaan/siswa/delete/{{ $item->id }}">Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
