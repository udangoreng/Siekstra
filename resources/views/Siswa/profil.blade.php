            ...
            <form method="POST" action="/siswa/edit/{{ $data->id }}">
                ...
                <div class="d-flex justify-content-between">
                    <div class="mb-3 me-2" style="width: 50%">
                        ...
                        <input type="text" value="{{ $data->nomor_hp_siswa }}" name="nomor_hp_siswa" id="nomor_hp"
